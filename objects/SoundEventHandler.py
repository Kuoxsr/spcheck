...
class SoundEventHandler:
    def __init__(self, json_events: str):
        self.raw_json: str = json_events
    ...
    def _parse_json(self) -> dict[str, SoundEvent]:
        ...
        json_dict: dict[str, SoundEvent] = dict(json.loads(self.raw_json))
    ...
    def get_sound_files(self, event_name: str = None):
        ...
        sound_files = [Path(s).with_suffix(".ogg") for s in sounds]
        return sorted(sound_files)  # noqa
